...
export const MODS = [
  ...
  { id: 'ghost-blocks', name: 'Ghost Blocks', cat: 'building', icon: 'box', on: false, boostCutoff: 2,
    desc: 'Renders the loaded schematic as translucent guide blocks in the world.',
    cfg: [slider('opacity', 'Ghost opacity', 10, 80, 40, '%'), toggle('wrongBlocks', 'Highlight wrong blocks', true)] },
  { id: 'build-progress', name: 'Build Progress', cat: 'building', icon: 'bar', on: false, boostCutoff: 3,
    desc: 'Placed vs. remaining blocks of the loaded schematic as a HUD bar.',
    cfg: [toggle('percent', 'Show percentage', true)] },
  { id: 'material-tracker', name: 'Material Tracker', cat: 'building', icon: 'layers', on: false, boostCutoff: 3,
    desc: 'Live checklist of missing materials — parsed from the schematic on the Worlds page.',
    cfg: [toggle('stacks', 'Show as stacks of 64', true)] },
  { id: 'build-presets', name: 'Building Presets', cat: 'building', icon: 'save', on: false,
    desc: 'Quick palettes and saved block sets for repeated builds.',
    cfg: [text('preset1', 'Palette 1', 'stone, stone_bricks, cracked_stone_bricks')] },
